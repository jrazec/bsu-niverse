...
class PopupConfigs {
  ...
  static final List<PopupConfig> gzbPopups = [
    PopupConfig(
      id: 'gzb_1',
      dialogue: 'Hello there! I am Sir Daryl Tiquio, want to take the challenge?',
      image: 'sirt.png',
      location: 'GZB Building - Ground Floor',
      questTitle: 'Meet our Database Guru!',
      questDescription: 'Find Sir Daryl in the GZB.',
    ),
    PopupConfig(
      id: 'gzb_2',
      dialogue: 'Excuse me! I\'m organizing a study group for our Computer Science exam. Would you like to join us?',
      image: 'mrs.balita-drawing.png',
      location: 'GZB Building - 2nd Floor',
      questTitle: 'Student needs yo help!',
    ...
    PopupConfig(
      ...
      image: 'dr.godoy-drawing.png',
      location: 'GZB Building - 3rd Floor',
    ...
    PopupConfig(
      ...
      image: 'dr.malaluan-drawing.png',
      location: 'GZB Building - 4th Floor',
    ...
    PopupConfig(
      ...
      image: 'dr.soquiat-drawing.png',
      location: 'GZB Building - 5th Floor',
  ...
  static final List<PopupConfig> vmbPopups = [
    PopupConfig(
      id: 'vmb_1',
      dialogue: 'Welcome to VMB! I am Dr. Magundayao, the Vice Chancellor for Academic Affairs!',
      image: 'dr.magundayao-drawing.png',
      location: 'VMB Building - Ground Floor',
      questTitle: 'Come and meet me!',
      questDescription: 'Find me in the Valerio Malabanan Building, and see what happens.',
    ),
    PopupConfig(
      id: 'vmb_2',
      dialogue: 'We\'re setting up a robotics exhibition. Can you help us arrange the display tables?',
      image: 'sirt.png',
      location: 'VMB Building - Second Floor',
  ...
  static final List<PopupConfig> abbPopups = [
    PopupConfig(
      id: 'abb_1',
      dialogue: 'I am Engr. Jonnah R. Melo! Come with me and have some challenge.',
      image: 'engr.melo-drawing.png',
  ...
  static final List<PopupConfig> lsbPopups = [
    PopupConfig(
      id: 'lsb_1',
      dialogue: 'Hi, I am Ms. Richelle M. Sulit. Want to have some challenge?',
      image: 'sirt.png',
      location: 'LSB Library - Ground Floor',
      questTitle: 'Meet Mam Sulit!',
      questDescription: 'Come and meet me hehe.',
    ),
    PopupConfig(
      id: 'lsb_2',
      dialogue: 'Hello, I am Dr. Ryndel V. Amorado. Nice to meet you!',
      image: 'dr.amorado-drawing.png',
    ...
    PopupConfig(
      id: 'lsb_4',
      dialogue: 'Hi I am Dr. Francis R. Balazon. Come and take the challenge!',
      image: 'dr.balazon-drawing.png',
    ...
    PopupConfig(
      ...
      image: 'mr.alimoren-drawing (1).png',
