        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildListTile(Icons.person_outline, "Profile", "View and edit your profile"),
              _buildListTile(Icons.star_border, "Achievements", "View your game achievements"),
              _buildSectionHeader("Game Settings"),
              _buildSwitchTile(Icons.volume_up_outlined, "Sound Effects", "Enable or disable sound effects", true),
              _buildListTile(Icons.gamepad_outlined, "Controls", "Customize game controls"),
              _buildSwitchTile(Icons.nightlight_round, "Dark Mode", "Switch to dark theme", false),
            ],
          ),
        ),
      );
        ...
        children: [
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                Text("Player",
                    style: TextStyle(fontFamily: 'PixeloidSans-Bold', fontSize: 14)),
                Text("Start your adventure today!",
                    style: TextStyle(fontFamily: 'PixeloidSans', fontSize: 12, color: Colors.grey)),
              ],
            ),
          ),
          ElevatedButton(
            ...
            child: const Text(
              "Edit",
              style: TextStyle(fontFamily: 'PixeloidSans-Bold', fontSize: 12, color: Colors.white),
            ),
          )
        ],
      ),
